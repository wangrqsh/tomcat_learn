...
public abstract class ContainerBase extends LifecycleMBeanBase
    ...
    protected synchronized void startInternal() throws LifecycleException {
        System.out.println(this.getClass().getName()+"_startInternal CODE");
    ...
    protected synchronized void stopInternal() throws LifecycleException {
        System.out.println(this.getClass().getName()+"_stopInternal CODE");
        // Stop our thread
        threadStop();
    ...
    protected void threadStart() {
        ...
        thread.start();
        System.out.println(this.getClass().getName()+"_ContainerBackgroundProcessor_start CODE");
    }
