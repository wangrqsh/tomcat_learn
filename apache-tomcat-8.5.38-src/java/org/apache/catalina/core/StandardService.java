...
public class StandardService extends LifecycleMBeanBase implements Service {
    ...
    public StandardService(){
        super();
        System.out.println(this.getClass().getName()+"_create CODE");
    }
    // ----------------------------------------------------- Instance Variables
    ...
    public void addConnector(Connector connector) {
        System.out.println(this.getClass().getName()+"_addConnector CODE");
    ...
    public void addExecutor(Executor ex) {
        System.out.println(this.getClass().getName()+"_addExecutor CODE");
